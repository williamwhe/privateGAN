...
class advGAN():
    ...
    def _build_model(self):
        ...
        with tf.variable_scope('evagan'):
            ...
            self.scaled_up = (self.fake_images_sample + 1) * 127.5
    ...
    def patch_discriminator(self, image, y=None, reuse=False):
        ...
        with tf.variable_scope("discriminator") as scope:
            ...
            if self.mnist is False:
                ...
                h4 = lrelu(self.d_bn4(conv2d(h3, self.df_dim*2, name='d_h4_conv')))
                print 'd_h4 shape:', h4.shape
                # h5 = lrelu(self.d_bn5(conv2d(h4, self.df_dim*8, d_h=1, d_w=1, name='d_h5_conv')))
                h5 = lrelu(self.d_bn5(conv2d(h4, self.df_dim*2, name='d_h5_conv')))
            ...
            return tf.nn.sigmoid(final_layer), final_layer
